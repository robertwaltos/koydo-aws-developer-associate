...
const EXAM_ID = "aws-developer-associate";
const EXAM_DISPLAY_NAME = "AWS Certified Developer - Associate";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover development with AWS services: Lambda, API Gateway, DynamoDB, S3, IAM, CloudFormation, CI/CD, and SDK/CLI usage. Align to DVA-C02 exam blueprint.
